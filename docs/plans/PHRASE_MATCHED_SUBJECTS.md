...
|---|---|
| ~~Which OpenAlex topic should this repository reach?~~ | **Answered 2026-08-19, before the run.** The set is `linguistics and terminology studies` T12881, `Semantic Web and Ontologies` T10215 and `Natural Language Processing Techniques` T10181; the rule is that any one of them reaches the top ten of the topics reached. [Recorded in full, with what it costs in falsifiability](EVERY_SIGNAL_REACHES_A_SUBJECT.md) |
