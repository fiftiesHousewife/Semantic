...
class DeclarationPhraseTest {
    ...
    void writesEveryKindTheChangeTouches() {
        assertThat(DeclarationPhrase.of(new ExportedWork.Declarations(5, 41, 22)))
    ...
    void leavesOutAKindTheChangeDoesNotTouch() {
        assertAll(
                () -> assertThat(DeclarationPhrase.of(new ExportedWork.Declarations(0, 8, 2)))
                        .isEqualTo("8 methods and 2 fields"),
                () -> assertThat(DeclarationPhrase.of(new ExportedWork.Declarations(3, 0, 0)))
                        .isEqualTo("3 types"));
    }

    @Test
    void writesOneOfAKindInTheSingular() {
        assertThat(DeclarationPhrase.of(new ExportedWork.Declarations(1, 1, 1)))
                .isEqualTo("1 type, 1 method and 1 field");
    }

    @Test
    void writesNothingWhereTheChangeTouchesNoKind() {
        assertThat(DeclarationPhrase.of(new ExportedWork.Declarations(0, 0, 0))).isEqualTo("nothing");
    }
}
