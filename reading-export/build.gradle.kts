...
description = "The published reading: reading.json, evidence.json and changes.json, validated against " +
        "the bundled schema, plus the read, evaluation and probe tasks that write and interrogate them"
...
dependencies {
    ...
    // Two probes walk the syntax tree themselves to show names in the grammar positions they hold.
