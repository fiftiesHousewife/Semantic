...
|--:|---|--:|--:|---|---|
| 12.5% | `telecommunication` | 0.0002 | 0.0415 | under | `file` 64.9% (240) `entry` 28.9% (186) `copy` 2.3% (27) `note` 2.0% (7) |
| 7.3% | `plants` | 0.0018 | 0.0317 | under | `root` 56.5% (161) `tree` 36.5% (191) `seed` 5.3% (38) `leaf` 0.8% (20) |
| 7.0% | `publishing` | 0.0171 | 0.0666 | under | `publish` 23.4% (324) `read` 13.2% (159) `write` 11.5% (670) `vocabulary` 10.5% (183) |
...
| 3.7% | `lexicography` | 0.0349 | 0.0089 | **over** | `citation` 85.7% (97) `sense` 10.8% (319) `gloss` 1.7% (2) `lemma` 1.2% (79) |
| 3.6% | `electronics` | 0.0008 | 0.0154 | under | `tsv` 86.7% (38) `field` 6.5% (204) `headroom` 3.1% (2) `bar` 1.2% (103) |
| 2.8% | `astrology` | 0.0000 | 0.0089 | under | `placement` 96.6% (106) `term` 1.5% (359) `figure` 1.2% (109) `scheme` 0.6% (41) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 8.0% | `telecommunication` | 0.0017 | 0.0415 | under | `file` 64.9% (240) `entry` 28.9% (186) `copy` 2.3% (27) `note` 2.0% (7) |
...
| 5.6% | `publishing` | 0.0167 | 0.0666 | under | `publish` 23.4% (324) `read` 13.2% (159) `write` 11.5% (670) `vocabulary` 10.5% (183) |
| 4.9% | `politics` | 0.0552 | 0.0130 | **over** | `vote` 51.4% (53) `normalisation` 23.4% (19) `reading` 6.4% (662) `name` 5.4% (786) |
| 3.8% | `literature` | 0.0016 | 0.0228 | under | `header` 35.5% (82) `write` 15.0% (669) `text` 12.4% (82) `prose` 8.4% (125) |
| 3.6% | `linguistics` | 0.3029 | 0.2018 | **over** | `word` 32.0% (1,511) `name` 15.8% (695) `term` 12.4% (348) `parse` 5.0% (146) |
| 3.5% | `law` | 0.0949 | 0.0429 | **over** | `file` 11.4% (489) `witness` 9.6% (73) `summary` 8.5% (57) `claim` 6.6% (111) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 14.4% | `electronics` | 0.0013 | 0.0154 | under | `tsv` 86.7% (38) `field` 6.5% (204) `headroom` 3.1% (2) `bar` 1.2% (103) |
| 11.6% | `chemistry` | 0.0019 | 0.0147 | under | `extraction` 33.0% (55) `fraction` 14.5% (13) `extract` 10.0% (7) `test` 8.2% (241) |
| 6.7% | `psychology` | 0.0015 | 0.0096 | under | `module` 81.9% (76) `confidence` 6.0% (20) `know` 3.7% (77) `test` 3.5% (241) |
...
| 2.7% | `literature` | 0.0132 | 0.0228 | under | `header` 35.5% (82) `write` 15.0% (669) `text` 12.4% (82) `prose` 8.4% (125) |
| 2.4% | `grammar` | 0.0426 | 0.0296 | **over** | `phrase` 21.7% (151) `occurrence` 16.0% (184) `part_of_speech` 15.8% (40) `verb` 13.7% (77) |
| 2.1% | `information-science` | 0.0011 | 0.0043 | under | `synset` 72.4% (28) `document` 21.3% (70) `ontology` 5.7% (116) `align` 0.4% (1) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 16.4% | `electronics` | 0.0004 | 0.0154 | under | `tsv` 86.7% (38) `field` 6.5% (204) `headroom` 3.1% (2) `bar` 1.2% (103) |
...
| 4.0% | `psychology` | 0.0026 | 0.0096 | under | `module` 81.9% (76) `confidence` 6.0% (20) `know` 3.7% (77) `test` 3.5% (241) |
| 3.2% | `computer-languages` | 0.0001 | 0.0030 | under | `json` 74.3% (6) `sparql` 10.9% (1) `owl` 8.1% (22) `java` 4.6% (70) |
| 3.0% | `astrology` | 0.0184 | 0.0089 | **over** | `placement` 96.6% (106) `term` 1.5% (359) `figure` 1.2% (109) `scheme` 0.6% (41) |
| 2.9% | `publishing` | 0.0888 | 0.0666 | **over** | `publish` 23.4% (324) `read` 13.2% (159) `write` 11.5% (670) `vocabulary` 10.5% (183) |
| 2.7% | `mathematics` | 0.0339 | 0.0498 | under | `from` 28.7% (147) `function` 10.0% (93) `distribution` 6.9% (98) `lemma` 6.4% (79) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 8.2% | `linguistics` | 0.0916 | 0.2018 | under | `word` 32.0% (1,511) `name` 15.8% (695) `term` 12.4% (348) `parse` 5.0% (146) |
| 7.2% | `literature` | 0.0840 | 0.0228 | **over** | `header` 35.5% (82) `write` 15.0% (669) `text` 12.4% (82) `prose` 8.4% (125) |
| 6.4% | `animals` | 0.0414 | 0.0047 | **over** | `nest` 57.1% (28) `owl` 28.1% (22) `head` 8.0% (14) `posterior` 3.5% (6) |
| 6.3% | `grammar` | 0.0012 | 0.0296 | under | `phrase` 21.7% (151) `occurrence` 16.0% (184) `part_of_speech` 15.8% (40) `verb` 13.7% (77) |
| 6.2% | `plants` | 0.0019 | 0.0317 | under | `root` 56.5% (161) `tree` 36.5% (191) `seed` 5.3% (38) `leaf` 0.8% (20) |
| 5.4% | `electronics` | 0.0596 | 0.0154 | **over** | `tsv` 86.7% (38) `field` 6.5% (204) `headroom` 3.1% (2) `bar` 1.2% (103) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 20.5% | `chemistry` | 0.1468 | 0.0147 | **over** | `extraction` 33.0% (55) `fraction` 14.5% (13) `extract` 10.0% (7) `test` 8.2% (241) |
| 16.6% | `electronics` | 0.1281 | 0.0154 | **over** | `tsv` 86.7% (38) `field` 6.5% (204) `headroom` 3.1% (2) `bar` 1.2% (103) |
| 5.5% | `linguistics` | 0.1019 | 0.2018 | under | `word` 32.0% (1,511) `name` 15.8% (695) `term` 12.4% (348) `parse` 5.0% (146) |
| 3.5% | `physics` | 0.0008 | 0.0192 | under | `mass` 46.4% (139) `weight` 30.2% (69) `length` 6.4% (74) `radius` 3.5% (3) |
| 2.9% | `person` | 0.0028 | 0.0223 | under | `reader` 26.1% (143) `child` 14.2% (21) `host` 11.9% (31) `bearer` 7.3% (18) |
| 2.8% | `psychology` | 0.0368 | 0.0096 | **over** | `module` 81.9% (76) `confidence` 6.0% (20) `know` 3.7% (77) `test` 3.5% (241) |
| 2.4% | `law` | 0.0146 | 0.0429 | under | `file` 11.4% (489) `witness` 9.6% (73) `summary` 8.5% (57) `claim` 6.6% (111) |
| 2.0% | `grammar` | 0.0086 | 0.0296 | under | `phrase` 21.7% (151) `occurrence` 16.0% (184) `part_of_speech` 15.8% (40) `verb` 13.7% (77) |
...
| 5.3% | `publishing` | 0.0193 | 0.0666 | under | `publish` 23.4% (324) `read` 13.2% (159) `write` 11.5% (670) `vocabulary` 10.5% (183) |
| 4.5% | `person` | 0.0674 | 0.0223 | **over** | `reader` 26.1% (143) `child` 14.2% (21) `host` 11.9% (31) `bearer` 7.3% (18) |
| 4.2% | `physics` | 0.0006 | 0.0192 | under | `mass` 46.4% (139) `weight` 30.2% (69) `length` 6.4% (74) `radius` 3.5% (3) |
| 4.2% | `mathematics` | 0.1079 | 0.0498 | **over** | `from` 28.7% (147) `function` 10.0% (93) `distribution` 6.9% (98) `lemma` 6.4% (79) |
| 4.0% | `networking` | 0.0305 | 0.0048 | **over** | `resource` 65.9% (265) `preamble` 9.8% (8) `request` 8.1% (11) `node` 6.5% (68) |
| 4.0% | `grammar` | 0.0757 | 0.0296 | **over** | `phrase` 21.7% (151) `occurrence` 16.0% (184) `part_of_speech` 15.8% (40) `verb` 13.7% (77) |
| 3.6% | `linguistics` | 0.2985 | 0.2018 | **over** | `word` 32.0% (1,511) `name` 15.8% (695) `term` 12.4% (348) `parse` 5.0% (146) |
...
| 5.8% | `linguistics` | 0.3064 | 0.2018 | **over** | `word` 32.0% (1,511) `name` 15.8% (695) `term` 12.4% (348) `parse` 5.0% (146) |
| 5.8% | `lexicography` | 0.0403 | 0.0089 | **over** | `citation` 85.7% (97) `sense` 10.8% (319) `gloss` 1.7% (2) `lemma` 1.2% (79) |
| 5.5% | `electronics` | 0.0000 | 0.0154 | under | `tsv` 86.7% (38) `field` 6.5% (204) `headroom` 3.1% (2) `bar` 1.2% (103) |
| 3.2% | `astrology` | 0.0000 | 0.0089 | under | `placement` 96.6% (106) `term` 1.5% (359) `figure` 1.2% (109) `scheme` 0.6% (41) |
| 2.6% | `chemistry` | 0.0024 | 0.0147 | under | `extraction` 33.0% (55) `fraction` 14.5% (13) `extract` 10.0% (7) `test` 8.2% (241) |
| 2.2% | `calculus` | 0.0000 | 0.0060 | under | `divergence` 100.0% (167) |
| 2.1% | `politics` | 0.0025 | 0.0130 | under | `vote` 51.4% (53) `normalisation` 23.4% (19) `reading` 6.4% (662) `name` 5.4% (786) |

### `documentation`

**24.0%** of the maximum divergence from the repository, against a null median of 34.4% over 999 resamples of the same size — an excess of -10.5 points, and 978 of those draws diverged at least as far. **The scope does not stand outside its own null**, so it has no topical content beyond its size and nothing is ranked.
