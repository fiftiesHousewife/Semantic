...
**15.9%** of the maximum divergence from the repository, against a null median of 9.7% over 999 resamples of the same size — an excess of +6.2 points, and 1 of those draws diverged at least as far. The scope stands outside its own null, so its topics are ranked below.

| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 12.5% | `telecommunication` | 0.0002 | 0.0411 | under | `file` 63.5% (222) `entry` 30.4% (189) `copy` 2.4% (28) `note` 1.7% (6) |
| 7.5% | `plants` | 0.0018 | 0.0323 | under | `root` 52.6% (158) `tree` 39.6% (199) `seed` 5.0% (45) `leaf` 2.0% (32) |
| 7.4% | `publishing` | 0.0173 | 0.0685 | under | `publish` 26.1% (344) `read` 12.5% (166) `write` 12.1% (696) `vocabulary` 9.7% (178) |
...
| 3.6% | `electronics` | 0.0007 | 0.0149 | under | `tsv` 86.7% (38) `field` 6.4% (199) `headroom` 3.2% (2) `bar` 1.3% (103) |
...
**20.4%** of the maximum divergence from the repository, against a null median of 15.5% over 999 resamples of the same size — an excess of +4.9 points, and 29 of those draws diverged at least as far. The scope stands outside its own null, so its topics are ranked below.

| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 8.0% | `telecommunication` | 0.0017 | 0.0411 | under | `file` 63.5% (222) `entry` 30.4% (189) `copy` 2.4% (28) `note` 1.7% (6) |
| 7.2% | `plants` | 0.0004 | 0.0323 | under | `root` 52.6% (158) `tree` 39.6% (199) `seed` 5.0% (45) `leaf` 2.0% (32) |
| 6.6% | `biology` | 0.0383 | 0.0026 | **over** | `morphology` 27.7% (19) `owl` 22.7% (24) `person` 8.7% (23) `glob` 7.8% (4) |
| 6.0% | `publishing` | 0.0167 | 0.0685 | under | `publish` 26.1% (344) `read` 12.5% (166) `write` 12.1% (696) `vocabulary` 9.7% (178) |
...
| 3.6% | `law` | 0.0949 | 0.0426 | **over** | `file` 10.7% (459) `witness` 9.5% (70) `summary` 8.4% (57) `verdict` 6.7% (10) |
| 3.5% | `linguistics` | 0.3029 | 0.2027 | **over** | `word` 32.0% (1,502) `name` 15.4% (680) `term` 13.0% (363) `parse` 4.5% (142) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 14.1% | `electronics` | 0.0013 | 0.0149 | under | `tsv` 86.7% (38) `field` 6.4% (199) `headroom` 3.2% (2) `bar` 1.3% (103) |
...
| 2.6% | `literature` | 0.0132 | 0.0223 | under | `header` 36.2% (81) `write` 16.6% (695) `text` 12.5% (85) `prose` 8.4% (118) |
| 2.3% | `grammar` | 0.0403 | 0.0281 | **over** | `phrase` 21.3% (147) `occurrence` 15.9% (171) `part_of_speech` 15.0% (38) `verb` 13.7% (74) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 17.7% | `electronics` | 0.0004 | 0.0149 | under | `tsv` 86.7% (38) `field` 6.4% (199) `headroom` 3.2% (2) `bar` 1.3% (103) |
| 12.9% | `plants` | 0.0678 | 0.0323 | **over** | `root` 52.6% (158) `tree` 39.6% (199) `seed` 5.0% (45) `leaf` 2.0% (32) |
...
| 3.2% | `mathematics` | 0.0321 | 0.0480 | under | `from` 28.0% (152) `function` 10.3% (96) `distribution` 6.8% (98) `lemma` 6.8% (78) |
| 3.1% | `publishing` | 0.0906 | 0.0685 | **over** | `publish` 26.1% (344) `read` 12.5% (166) `write` 12.1% (696) `vocabulary` 9.7% (178) |
| 2.5% | `astrology` | 0.0162 | 0.0084 | **over** | `placement` 95.3% (107) `term` 1.6% (375) `figure` 1.3% (107) `descendant` 1.2% (7) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 9.5% | `linguistics` | 0.0852 | 0.2027 | under | `word` 32.0% (1,502) `name` 15.4% (680) `term` 13.0% (363) `parse` 4.5% (142) |
| 7.3% | `literature` | 0.0837 | 0.0223 | **over** | `header` 36.2% (81) `write` 16.6% (695) `text` 12.5% (85) `prose` 8.4% (118) |
| 6.3% | `plants` | 0.0019 | 0.0323 | under | `root` 52.6% (158) `tree` 39.6% (199) `seed` 5.0% (45) `leaf` 2.0% (32) |
| 5.9% | `grammar` | 0.0012 | 0.0281 | under | `phrase` 21.3% (147) `occurrence` 15.9% (171) `part_of_speech` 15.0% (38) `verb` 13.7% (74) |
| 5.6% | `electronics` | 0.0596 | 0.0149 | **over** | `tsv` 86.7% (38) `field` 6.4% (199) `headroom` 3.2% (2) `bar` 1.3% (103) |
...
**21.9%** of the maximum divergence from the repository, against a null median of 7.2% over 999 resamples of the same size — an excess of +14.6 points, and 0 of those draws diverged at least as far. The scope stands outside its own null, so its topics are ranked below.

| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 20.1% | `chemistry` | 0.1427 | 0.0144 | **over** | `extraction` 33.1% (53) `fraction` 14.6% (13) `extract` 10.1% (7) `test` 8.2% (243) |
| 16.2% | `electronics` | 0.1242 | 0.0149 | **over** | `tsv` 86.7% (38) `field` 6.4% (199) `headroom` 3.2% (2) `bar` 1.3% (103) |
| 6.0% | `linguistics` | 0.0990 | 0.2027 | under | `word` 32.0% (1,502) `name` 15.4% (680) `term` 13.0% (363) `parse` 4.5% (142) |
| 3.7% | `physics` | 0.0007 | 0.0199 | under | `mass` 47.9% (136) `weight` 27.6% (65) `length` 6.8% (72) `radius` 3.6% (2) |
| 3.0% | `person` | 0.0027 | 0.0229 | under | `reader` 26.7% (136) `child` 14.3% (22) `host` 10.1% (29) `bearer` 7.2% (18) |
| 2.8% | `psychology` | 0.0357 | 0.0091 | **over** | `module` 81.8% (72) `confidence` 4.5% (18) `test` 3.7% (243) `know` 3.4% (74) |
| 2.5% | `law` | 0.0142 | 0.0426 | under | `file` 10.7% (459) `witness` 9.5% (70) `summary` 8.4% (57) `verdict` 6.7% (10) |
| 1.9% | `economy` | 0.0001 | 0.0092 | under | `mark_down` 42.7% (18) `found` 19.5% (27) `property` 14.1% (52) `total` 10.0% (16) |

### `lexicon/src/main/java`

**19.3%** of the maximum divergence from the repository, against a null median of 10.7% over 999 resamples of the same size — an excess of +8.6 points, and 0 of those draws diverged at least as far. The scope stands outside its own null, so its topics are ranked below.

| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 8.3% | `plants` | 0.0000 | 0.0323 | under | `root` 52.6% (158) `tree` 39.6% (199) `seed` 5.0% (45) `leaf` 2.0% (32) |
| 6.0% | `publishing` | 0.0175 | 0.0685 | under | `publish` 26.1% (344) `read` 12.5% (166) `write` 12.1% (696) `vocabulary` 9.7% (178) |
| 4.3% | `person` | 0.0673 | 0.0229 | **over** | `reader` 26.7% (136) `child` 14.3% (22) `host` 10.1% (29) `bearer` 7.2% (18) |
| 4.3% | `physics` | 0.0006 | 0.0199 | under | `mass` 47.9% (136) `weight` 27.6% (65) `length` 6.8% (72) `radius` 3.6% (2) |
| 4.1% | `linguistics` | 0.3075 | 0.2027 | **over** | `word` 32.0% (1,502) `name` 15.4% (680) `term` 13.0% (363) `parse` 4.5% (142) |
| 3.9% | `networking` | 0.0307 | 0.0050 | **over** | `resource` 69.6% (254) `preamble` 9.0% (8) `request` 6.4% (9) `node` 6.0% (70) |
| 3.8% | `grammar` | 0.0726 | 0.0281 | **over** | `phrase` 21.3% (147) `occurrence` 15.9% (171) `part_of_speech` 15.0% (38) `verb` 13.7% (74) |
| 3.6% | `mathematics` | 0.1014 | 0.0480 | **over** | `from` 28.0% (152) `function` 10.3% (96) `distribution` 6.8% (98) `lemma` 6.8% (78) |

### `lexicon/src/test/java`

**13.6%** of the maximum divergence from the repository, against a null median of 11.0% over 999 resamples of the same size — an excess of +2.6 points, and 61 of those draws diverged at least as far. The scope stands outside its own null, so its topics are ranked below.

| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 11.3% | `plants` | 0.0002 | 0.0323 | under | `root` 52.6% (158) `tree` 39.6% (199) `seed` 5.0% (45) `leaf` 2.0% (32) |
| 5.7% | `lexicography` | 0.0393 | 0.0085 | **over** | `citation` 87.0% (94) `sense` 10.0% (310) `lemma` 1.3% (78) `gloss` 1.1% (1) |
| 5.6% | `linguistics` | 0.3064 | 0.2027 | **over** | `word` 32.0% (1,502) `name` 15.4% (680) `term` 13.0% (363) `parse` 4.5% (142) |
| 5.4% | `electronics` | 0.0000 | 0.0149 | under | `tsv` 86.7% (38) `field` 6.4% (199) `headroom` 3.2% (2) `bar` 1.3% (103) |
...
**23.6%** of the maximum divergence from the repository, against a null median of 34.8% over 999 resamples of the same size — an excess of -11.2 points, and 975 of those draws diverged at least as far. **The scope does not stand outside its own null**, so it has no topical content beyond its size and nothing is ranked.
