...
| 6.7% | `publishing` | 0.0171 | 0.0650 | under | `publish` 22.9% (294) `read` 13.8% (159) `write` 11.6% (646) `vocabulary` 10.4% (166) |
...
| 4.8% | `time_period` | 0.0292 | 0.0041 | **over** | `span` 46.6% (19) `none` 24.1% (8) `long` 5.4% (23) `even` 4.9% (4) |
| 3.7% | `electronics` | 0.0008 | 0.0156 | under | `tsv` 86.7% (38) `field` 6.5% (196) `headroom` 3.1% (2) `bar` 1.2% (103) |
| 3.7% | `lexicography` | 0.0349 | 0.0091 | **over** | `citation` 85.7% (96) `sense` 10.8% (313) `gloss` 1.7% (2) `lemma` 1.2% (78) |
| 2.8% | `astrology` | 0.0000 | 0.0091 | under | `placement` 96.8% (102) `term` 1.4% (332) `figure` 1.2% (105) `scheme` 0.5% (36) |
...
| 6.7% | `biology` | 0.0383 | 0.0024 | **over** | `morphology` 30.2% (19) `owl` 21.7% (22) `person` 9.5% (23) `glob` 8.6% (5) |
| 6.5% | `plants` | 0.0004 | 0.0293 | under | `root` 57.0% (150) `tree` 37.8% (172) `seed` 3.5% (28) `leaf` 0.9% (19) |
| 5.3% | `publishing` | 0.0167 | 0.0650 | under | `publish` 22.9% (294) `read` 13.8% (159) `write` 11.6% (646) `vocabulary` 10.4% (166) |
| 4.9% | `politics` | 0.0552 | 0.0132 | **over** | `vote` 51.7% (53) `normalisation` 23.5% (19) `reading` 6.2% (629) `name` 5.4% (759) |
| 3.9% | `literature` | 0.0016 | 0.0230 | under | `header` 36.2% (79) `write` 14.9% (645) `text` 12.6% (80) `prose` 8.5% (112) |
| 3.7% | `linguistics` | 0.3029 | 0.2002 | **over** | `word` 32.4% (1,477) `name` 16.1% (668) `term` 12.1% (323) `parse` 4.9% (138) |
| 3.5% | `law` | 0.0949 | 0.0430 | **over** | `file` 11.5% (470) `witness` 9.8% (73) `summary` 8.6% (55) `claim` 6.7% (111) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 13.5% | `electronics` | 0.0014 | 0.0156 | under | `tsv` 86.7% (38) `field` 6.5% (196) `headroom` 3.1% (2) `bar` 1.2% (103) |
| 10.7% | `chemistry` | 0.0020 | 0.0149 | under | `extraction` 33.1% (51) `fraction` 14.6% (13) `extract` 10.1% (7) `test` 8.0% (234) |
...
| 2.9% | `literature` | 0.0128 | 0.0230 | under | `header` 36.2% (79) `write` 14.9% (645) `text` 12.6% (80) `prose` 8.5% (112) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 16.9% | `electronics` | 0.0004 | 0.0156 | under | `tsv` 86.7% (38) `field` 6.5% (196) `headroom` 3.1% (2) `bar` 1.2% (103) |
...
| 3.5% | `publishing` | 0.0891 | 0.0650 | **over** | `publish` 22.9% (294) `read` 13.8% (159) `write` 11.6% (646) `vocabulary` 10.4% (166) |
| 3.3% | `computer-languages` | 0.0001 | 0.0030 | under | `json` 74.8% (6) `sparql` 10.9% (1) `owl` 7.9% (22) `java` 4.2% (67) |
| 3.2% | `mathematics` | 0.0334 | 0.0506 | under | `from` 28.8% (146) `function` 10.0% (86) `distribution` 6.9% (89) `lemma` 6.4% (78) |
| 3.0% | `astrology` | 0.0184 | 0.0091 | **over** | `placement` 96.8% (102) `term` 1.4% (332) `figure` 1.2% (105) `scheme` 0.5% (36) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 8.0% | `linguistics` | 0.0916 | 0.2002 | under | `word` 32.4% (1,477) `name` 16.1% (668) `term` 12.1% (323) `parse` 4.9% (138) |
| 7.2% | `literature` | 0.0840 | 0.0230 | **over** | `header` 36.2% (79) `write` 14.9% (645) `text` 12.6% (80) `prose` 8.5% (112) |
...
| 5.3% | `electronics` | 0.0596 | 0.0156 | **over** | `tsv` 86.7% (38) `field` 6.5% (196) `headroom` 3.1% (2) `bar` 1.2% (103) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 20.5% | `chemistry` | 0.1468 | 0.0149 | **over** | `extraction` 33.1% (51) `fraction` 14.6% (13) `extract` 10.1% (7) `test` 8.0% (234) |
| 16.5% | `electronics` | 0.1281 | 0.0156 | **over** | `tsv` 86.7% (38) `field` 6.5% (196) `headroom` 3.1% (2) `bar` 1.2% (103) |
| 5.4% | `linguistics` | 0.1019 | 0.2002 | under | `word` 32.4% (1,477) `name` 16.1% (668) `term` 12.1% (323) `parse` 4.9% (138) |
...
| 2.4% | `law` | 0.0146 | 0.0430 | under | `file` 11.5% (470) `witness` 9.8% (73) `summary` 8.6% (55) `claim` 6.7% (111) |
...
| 5.0% | `publishing` | 0.0192 | 0.0650 | under | `publish` 22.9% (294) `read` 13.8% (159) `write` 11.6% (646) `vocabulary` 10.4% (166) |
...
| 4.1% | `mathematics` | 0.1079 | 0.0506 | **over** | `from` 28.8% (146) `function` 10.0% (86) `distribution` 6.9% (89) `lemma` 6.4% (78) |
...
| 3.7% | `linguistics` | 0.2985 | 0.2002 | **over** | `word` 32.4% (1,477) `name` 16.1% (668) `term` 12.1% (323) `parse` 4.9% (138) |
...
| 7.1% | `linguistics` | 0.3217 | 0.2002 | **over** | `word` 32.4% (1,477) `name` 16.1% (668) `term` 12.1% (323) `parse` 4.9% (138) |
| 5.8% | `lexicography` | 0.0423 | 0.0091 | **over** | `citation` 85.7% (96) `sense` 10.8% (313) `gloss` 1.7% (2) `lemma` 1.2% (78) |
| 5.3% | `electronics` | 0.0000 | 0.0156 | under | `tsv` 86.7% (38) `field` 6.5% (196) `headroom` 3.1% (2) `bar` 1.2% (103) |
| 3.1% | `astrology` | 0.0000 | 0.0091 | under | `placement` 96.8% (102) `term` 1.4% (332) `figure` 1.2% (105) `scheme` 0.5% (36) |
| 3.0% | `chemistry` | 0.0017 | 0.0149 | under | `extraction` 33.1% (51) `fraction` 14.6% (13) `extract` 10.1% (7) `test` 8.0% (234) |
| 2.1% | `calculus` | 0.0000 | 0.0061 | under | `divergence` 100.0% (165) |
| 2.0% | `information-science` | 0.0171 | 0.0044 | **over** | `synset` 72.5% (26) `document` 21.3% (66) `ontology` 5.6% (104) `align` 0.4% (1) |

### `documentation`

**23.9%** of the maximum divergence from the repository, against a null median of 35.1% over 999 resamples of the same size — an excess of -11.1 points, and 980 of those draws diverged at least as far. **The scope does not stand outside its own null**, so it has no topical content beyond its size and nothing is ranked.

Read, compared and resampled in 10.6 s, recorded rather than estimated.
