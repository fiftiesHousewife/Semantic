...
|---|--:|--:|--:|--:|--:|--:|---|
| `linguistics` | 0.0492 | 65.5% | 4,679 | 183 | 14,915 | 34.2% | `word` 30.5% (1,644) `name` 15.6% (806) `term` 15.3% (397) `parse` 5.0% (168) |
| `computing` | 0.0149 | 72.3% | 7,252 | 37 | 2,121 | 4.9% | `repository` 6.1% (490) `read` 5.2% (1,016) `folder` 4.6% (40) `byte` 3.8% (48) |
...
| 5.0% | `law` | 0.1071 | 0.0413 | **over** | `file` 10.9% (564) `witness` 9.4% (73) `summary` 7.6% (57) `claim` 6.5% (119) |
| 4.0% | `linguistics` | 0.3002 | 0.1919 | **over** | `word` 30.5% (1,644) `name` 15.6% (806) `term` 15.3% (397) `parse` 5.0% (168) |
| 3.8% | `literature` | 0.0017 | 0.0238 | under | `header` 36.7% (94) `write` 17.1% (782) `text` 13.0% (111) `prose` 9.1% (147) |
...
| 3.9% | `literature` | 0.0121 | 0.0238 | under | `header` 36.7% (94) `write` 17.1% (782) `text` 13.0% (111) `prose` 9.1% (147) |
| 3.7% | `animals` | 0.0003 | 0.0040 | under | `nest` 55.5% (29) `owl` 26.0% (24) `tail` 8.3% (26) `head` 6.2% (14) |
| 3.4% | `calculus` | 0.0121 | 0.0047 | **over** | `divergence` 100.0% (155) |
| 2.9% | `grammar` | 0.0425 | 0.0283 | **over** | `phrase` 21.9% (172) `occurrence` 15.9% (187) `verb` 15.1% (86) `part_of_speech` 12.1% (37) |
| 2.8% | `linguistics` | 0.2257 | 0.1919 | **over** | `word` 30.5% (1,644) `name` 15.6% (806) `term` 15.3% (397) `parse` 5.0% (168) |
...
| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 14.2% | `linguistics` | 0.0687 | 0.1919 | under | `word` 30.5% (1,644) `name` 15.6% (806) `term` 15.3% (397) `parse` 5.0% (168) |
| 7.5% | `literature` | 0.0801 | 0.0238 | **over** | `header` 36.7% (94) `write` 17.1% (782) `text` 13.0% (111) `prose` 9.1% (147) |
...
| 3.8% | `money` | 0.0001 | 0.0124 | under | `share` 63.9% (347) `score` 17.5% (64) `say` 7.3% (302) `coverage` 3.8% (18) |
...
| 8.8% | `linguistics` | 0.0853 | 0.1919 | under | `word` 30.5% (1,644) `name` 15.6% (806) `term` 15.3% (397) `parse` 5.0% (168) |
...
| 4.6% | `linguistics` | 0.2971 | 0.1919 | **over** | `word` 30.5% (1,644) `name` 15.6% (806) `term` 15.3% (397) `parse` 5.0% (168) |
...
| 3.8% | `linguistics` | 0.2664 | 0.1919 | **over** | `word` 30.5% (1,644) `name` 15.6% (806) `term` 15.3% (397) `parse` 5.0% (168) |
...
**22.8%** of the maximum divergence from the repository, against a null median of 34.8% over 999 resamples of the same size — an excess of -12.0 points, and 988 of those draws diverged at least as far. **The scope does not stand outside its own null**, so it has no topical content beyond its size and nothing is ranked.
...
| 2.5% | `law` | 0.0020 | 0.0413 | under | `file` 10.9% (564) `witness` 9.4% (73) `summary` 7.6% (57) `claim` 6.5% (119) |
| 2.5% | `linguistics` | 0.0839 | 0.1919 | under | `word` 30.5% (1,644) `name` 15.6% (806) `term` 15.3% (397) `parse` 5.0% (168) |

Read, compared and resampled in 9.4 s, recorded rather than estimated.
