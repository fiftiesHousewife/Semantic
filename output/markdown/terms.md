...
**OLiA** publishes **1,311 concepts** in a hierarchy 9 rungs deep. This repository writes **80 of them, 1,351 times**, across 376 of 581 files — reaching **15 of the taxonomy's 70 root branches**.
...
|---|--:|--:|--:|---|
| `LinguisticConcept` | 16 | 136 | 526 | `Source` 208 `Set` 81 `Document` 35 `Means` 34 `Evidence` 32 `Given` 30 `Heading` 23 `Sentence` 20 |
| `OrthographicEntity` | 6 | 37 | 191 | `Token` 91 `Text` 58 `Letter` 24 `Script` 14 `String` 3 `Character` 1 |
| `MorphologicalCategory` | 5 | 16 | 182 | `Root` 140 `Prefix` 18 `Suffix` 18 `Stem` 5 `Affix` 1 |
| `MorphosyntacticCategory` | 17 | 288 | 165 | `Verb` 41 `Noun` 37 `Abbreviation` 21 `Symbol` 17 `Initialism` 11 `Residual` 11 `Foreign` 8 `Acronym` 5 |
...
|---|--:|--:|--:|
| the words themselves | 1,030 | 65 | 97.8% |
...
|---|--:|--:|--:|--:|---|
| every match | 2,262 | 194 | 98.9% | 22 of 70 | `topic` 218 |
| only where the branch holds more than this one concept | 1,351 | 129 | 98.1% | 15 of 70 | `source` 185 |
...
|---|--:|--:|--:|--:|
| what the branch admitted | 80 | 1,351 | 2.30 | 2.23 |
| what the branch refused | 37 | 805 | 3.14 | 2.37 |
...
The shallowest: `Verb` 1 rung, 41 `Trial` 1 rung, 1 `Token` 1 rung, 91 `Third` 1 rung, 3 `Text` 1 rung, 58 `Superlative` 1 rung, 1 `String` 1 rung, 3 `Singular` 1 rung, 2.
