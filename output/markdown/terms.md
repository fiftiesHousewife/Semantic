...
**OLiA** publishes **1,311 concepts** in a hierarchy nine levels deep. This repository writes **68 of them, 1,306 times**, across 326 of 460 files — reaching **12 of the taxonomy's 70 root branches**.
...
|---|--:|--:|--:|---|
| `LinguisticConcept` | 16 | 136 | 528 | `Source` 161 `Set` 111 `Citation` 34 `Means` 33 `Document` 32 `Evidence` 31 `Given` 25 `PartOf` 21 |
...
| `MorphologicalCategory` | 5 | 16 | 148 | `Root` 111 `Suffix` 16 `Prefix` 15 `Stem` 5 `Affix` 1 |
| `OrthographicEntity` | 4 | 37 | 142 | `Token` 87 `Text` 39 `Script` 14 `String` 2 |
| `PersonFeature` | 3 | 10 | 96 | `First` 66 `Second` 27 `Third` 3 |
| `Constituent` | 4 | 37 | 84 | `Phrase` 66 `Fragment` 9 `Clause` 7 `Chunk` 2 |
| `Relation` | 8 | 203 | 60 | `Definition` 18 `Comparison` 10 `Expansion` 10 `Consequence` 9 `Evaluation` 8 `Attribution` 3 `Exception` 1 `Extra` 1 |
| `SemanticFeature` | 5 | 125 | 58 | `Function` 34 `Time` 10 `Amount` 7 `Plan` 4 `Object` 3 |
...
|---|--:|--:|--:|
| the words themselves | 1,004 | 60 | 97.7% |
| the dictionary form of each word | 175 | 35 | 99.4% |
| the sense the dictionary carries each word in | 127 | 21 | 99.2% |
...
|---|--:|--:|--:|--:|---|
| every match | 1,970 | 173 | 98.7% | 22 of 70 | `topic` 199 |
| only where the branch holds more than this one concept | 1,306 | 116 | 98.1% | 12 of 70 | `source` 135 |
...
| `topics` | 92 | `PragmaticUnit` |
| `subject` | 72 | `PragmaticUnit` |
| `subjects` | 28 | `PragmaticUnit` |
| `other` | 23 | `SameType` |
...
|---|--:|--:|--:|--:|
| what the branch admitted | 68 | 1,306 | 2.28 | 2.23 |
| what the branch refused | 36 | 673 | 3.11 | 2.33 |

The deepest of what was written: `Consequence` 6 rungs, 9 `Definition` 6 rungs, 18 `Evaluation` 6 rungs, 8 `Evidence` 5 rungs, 31 `Exception` 5 rungs, 1 `Active` 4 rungs, 2 `Attribution` 4 rungs, 3 `Comparison` 4 rungs, 10.
