...
|---|---|--:|--:|---|
| Archive | **Computer Science** | 34.5% | 41.0% | apart from chance |
| Category | **Computation and Language** | 39.7% | 44.9% | apart from chance |
...
|---|--:|---|
| `code-semantics-api/src/test/java` | 21.6% | `linguistics` |
| `lexicon-extraction/src/test/java` | 19.0% | `computing` |
| `lexicon/src/main/java` | 18.1% | `linguistics` |
| `lexicon/src/test/java` | 12.2% | `linguistics` |
| `code-semantics-engine/src/main/java` | 3.5% | `linguistics` |

## Withheld

- `documentation` — 23.3% of the maximum divergence, and 979 of 999 chance draws stood at least as far
