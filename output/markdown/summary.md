...
|---|---|--:|--:|---|
| Archive | **Computer Science** | 34.5% | 41.2% | apart from chance |
| Category | **Computation and Language** | 39.4% | 44.8% | apart from chance |
...
The topics distinguishing some part of this repository from the rest, commonest first: `linguistics`, `computing`.
...
|---|--:|---|
| `code-semantics-api/src/test/java` | 21.1% | `linguistics` |
| `lexicon-extraction/src/test/java` | 20.1% | `computing` |
| `lexicon/src/main/java` | 18.4% | `linguistics` |
| `lexicon/src/test/java` | 12.3% | `linguistics` |
| `code-semantics-engine/src/main/java` | 3.2% | `linguistics` |

## Withheld

- `documentation` — 23.1% of the maximum divergence, and 983 of 999 chance draws stood at least as far
