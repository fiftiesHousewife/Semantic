...
|---|---|--:|--:|---|
| Archive | **Computer Science** | 34.5% | 41.1% | apart from chance |
| Category | **Computation and Language** | 39.6% | 44.7% | apart from chance |
...
|---|--:|---|
| `code-semantics-api/src/test/java` | 21.4% | `linguistics` |
| `lexicon-extraction/src/test/java` | 19.7% | `computing` |
| `lexicon/src/main/java` | 18.6% | `linguistics` |
| `lexicon/src/test/java` | 12.6% | `linguistics` |
| `code-semantics-engine/src/main/java` | 3.5% | `linguistics` |

## Withheld

- `documentation` — 23.4% of the maximum divergence, and 979 of 999 chance draws stood at least as far
