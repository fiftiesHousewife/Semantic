...
| Category | **Computation and Language** | 39.6% | 45.0% | apart from chance |
...
|---|--:|---|
| `lexicon-extraction/src/test/java` | 19.9% | `computing` |
| `lexicon/src/main/java` | 18.4% | `linguistics` |
| `lexicon/src/test/java` | 12.0% | `linguistics`, `computing` |

## Withheld

- `documentation` — 23.4% of the maximum divergence, and 973 of 999 chance draws stood at least as far
