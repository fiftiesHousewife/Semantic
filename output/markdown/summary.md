...
|---|---|--:|--:|---|
| Archive | **Computer Science** | 34.1% | 41.1% | apart from chance |
| Category | **Computation and Language** | 40.0% | 44.7% | apart from chance |
...
|---|--:|---|
| `code-semantics-api/src/test/java` | 20.5% | `linguistics` |
| `lexicon/src/test/java` | 14.5% | `linguistics` |
| `code-semantics-engine/src/main/java` | 3.7% | `linguistics` |

## Withheld

- `documentation` — 23.7% of the maximum divergence, and 968 of 999 chance draws stood at least as far
