...
| `code-semantics-engine/src/main/java` | 178 | 3,806 | 5,413 | 38,446 (87.7%) | 43,232 | **0.986** |
| `code-semantics-engine/src/test/java` | 169 | 3,175 | 10,364 | 8,063 (43.8%) | 18,271 | **0.992** |
...
| **repository** | 512 | 9,674 | 22,836 | 70,020 (75.4%) | 91,275 | **0.983** |

The repository's own words are 92,856 occurrences of 3,892 distinct surfaces, 1,226 of them (31.5%) written exactly once. 223 glued runs no boundary divided were read by the segmenter; 1,581 occurrences across 442 surfaces nothing could be cited for at all.

| Resource | Occurrences it can be cited for | Share | Resting on it alone |
|---|--:|--:|--:|
| `lexicon:word-frequency` | 88,143 | 94.9% | 4,295 |
| `lexicon:wordnet-sense` | 63,274 | 68.1% | 1,108 |
| `lexicon:wiktionary-topic` | 51,861 | 55.9% | 210 |
| `lexicon:wikidata-initialism` | 41,572 | 44.8% | 71 |
| `lexicon:wikidata-name` | 37,133 | 40.0% | 39 |
| `lexicon:wordnet-domain` | 36,969 | 39.8% | 118 |
| `lexicon:wiktionary-abbreviation` | 32,086 | 34.6% | 9 |
| `catalogue:query-language-function` | 1,386 | 1.5% | 1 |
...
Read 512 files in 1.5 s — 3.0 ms a file, recorded rather than estimated.

Imports read as this repository's own choice: 81. Set aside as the platform's own vocabulary: 1478. Set aside as this repository's own coordinates: 487. Set aside as the toolchain a source set nothing is published from is checked with: 832. Files the parser refused: 0.