...
| `code-semantics-engine/src/main/java` | 185 | 3,998 | 5,706 | 39,677 (87.4%) | 44,702 | **0.985** |
| `code-semantics-engine/src/test/java` | 175 | 3,395 | 10,964 | 8,298 (43.1%) | 19,097 | **0.991** |
...
| **repository** | 552 | 10,321 | 24,462 | 73,027 (74.9%) | 95,802 | **0.983** |

The repository's own words are 97,489 occurrences of 3,995 distinct surfaces, 1,258 of them (31.5%) written exactly once. 228 glued runs no boundary divided were read by the segmenter; 1,687 occurrences across 473 surfaces nothing could be cited for at all.

| Resource | Occurrences it can be cited for | Share | Resting on it alone |
|---|--:|--:|--:|
| `lexicon:word-frequency` | 92,458 | 94.8% | 4,450 |
| `lexicon:wordnet-sense` | 66,541 | 68.3% | 1,183 |
| `lexicon:wiktionary-topic` | 54,460 | 55.9% | 221 |
| `lexicon:wikidata-initialism` | 43,607 | 44.7% | 77 |
| `lexicon:wikidata-name` | 38,944 | 39.9% | 44 |
| `lexicon:wordnet-domain` | 38,789 | 39.8% | 117 |
| `lexicon:wiktionary-abbreviation` | 33,594 | 34.5% | 10 |
| `catalogue:query-language-function` | 1,461 | 1.5% | 1 |
...
Read 552 files in 1.6 s — 2.9 ms a file, recorded rather than estimated.

Imports read as this repository's own choice: 83. Set aside as the platform's own vocabulary: 1531. Set aside as this repository's own coordinates: 519. Set aside as the toolchain a source set nothing is published from is checked with: 892. Files the parser refused: 0.