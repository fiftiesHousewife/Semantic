...
| `code-semantics-engine/src/test/java` | 171 | 3,241 | 10,535 | 8,032 (43.3%) | 18,417 | **0.992** |
...
| `documentation` | 3 | 0 | 0 | 9,665 (100.0%) | 9,326 | **0.965** |
| **repository** | 544 | 10,057 | 23,844 | 71,847 (75.1%) | 94,067 | **0.983** |

The repository's own words are 95,691 occurrences of 3,941 distinct surfaces, 1,235 of them (31.3%) written exactly once. 231 glued runs no boundary divided were read by the segmenter; 1,624 occurrences across 461 surfaces nothing could be cited for at all.

| Resource | Occurrences it can be cited for | Share | Resting on it alone |
|---|--:|--:|--:|
| `lexicon:word-frequency` | 90,798 | 94.9% | 4,395 |
| `lexicon:wordnet-sense` | 65,264 | 68.2% | 1,156 |
| `lexicon:wiktionary-topic` | 53,451 | 55.9% | 212 |
| `lexicon:wikidata-initialism` | 42,853 | 44.8% | 75 |
| `lexicon:wikidata-name` | 38,254 | 40.0% | 42 |
| `lexicon:wordnet-domain` | 38,048 | 39.8% | 116 |
| `lexicon:wiktionary-abbreviation` | 33,003 | 34.5% | 9 |
...
Imports read as this repository's own choice: 82. Set aside as the platform's own vocabulary: 1502. Set aside as this repository's own coordinates: 494. Set aside as the toolchain a source set nothing is published from is checked with: 885. Files the parser refused: 0.