...
| `code-semantics-engine/src/main/java` | 190 | 4,127 | 5,894 | 40,280 (87.2%) | 45,472 | **0.985** |
| `code-semantics-engine/src/test/java` | 180 | 3,465 | 11,231 | 8,330 (42.6%) | 19,394 | **0.991** |
...
| **repository** | 572 | 10,530 | 24,944 | 73,662 (74.7%) | 96,896 | **0.983** |

The repository's own words are 98,606 occurrences of 4,013 distinct surfaces, 1,256 of them (31.3%) written exactly once. 228 glued runs no boundary divided were read by the segmenter; 1,710 occurrences across 475 surfaces nothing could be cited for at all.

| Resource | Occurrences it can be cited for | Share | Resting on it alone |
|---|--:|--:|--:|
| `lexicon:word-frequency` | 93,503 | 94.8% | 4,491 |
| `lexicon:wordnet-sense` | 67,380 | 68.3% | 1,193 |
| `lexicon:wiktionary-topic` | 55,115 | 55.9% | 221 |
| `lexicon:wikidata-initialism` | 44,086 | 44.7% | 77 |
| `lexicon:wikidata-name` | 39,375 | 39.9% | 45 |
| `lexicon:wordnet-domain` | 39,293 | 39.8% | 117 |
| `lexicon:wiktionary-abbreviation` | 34,032 | 34.5% | 10 |
| `catalogue:query-language-function` | 1,467 | 1.5% | 1 |
...
Read 572 files in 1.7 s — 2.9 ms a file, recorded rather than estimated.

Imports read as this repository's own choice: 83. Set aside as the platform's own vocabulary: 1583. Set aside as this repository's own coordinates: 519. Set aside as the toolchain a source set nothing is published from is checked with: 910. Files the parser refused: 0.
