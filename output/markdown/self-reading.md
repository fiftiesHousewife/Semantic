...
| `code-semantics-engine/src/main/java` | 178 | 3,807 | 5,414 | 38,345 (87.6%) | 43,135 | **0.986** |
| `code-semantics-engine/src/test/java` | 168 | 3,163 | 10,325 | 8,063 (43.8%) | 18,232 | **0.992** |
...
| **repository** | 511 | 9,663 | 22,798 | 69,919 (75.4%) | 91,139 | **0.983** |

The repository's own words are 92,717 occurrences of 3,887 distinct surfaces, 1,225 of them (31.5%) written exactly once. 223 glued runs no boundary divided were read by the segmenter; 1,578 occurrences across 440 surfaces nothing could be cited for at all.

| Resource | Occurrences it can be cited for | Share | Resting on it alone |
|---|--:|--:|--:|
| `lexicon:word-frequency` | 88,012 | 94.9% | 4,290 |
| `lexicon:wordnet-sense` | 63,183 | 68.1% | 1,106 |
| `lexicon:wiktionary-topic` | 51,788 | 55.9% | 210 |
| `lexicon:wikidata-initialism` | 41,503 | 44.8% | 71 |
| `lexicon:wikidata-name` | 37,077 | 40.0% | 39 |
| `lexicon:wordnet-domain` | 36,910 | 39.8% | 118 |
| `lexicon:wiktionary-abbreviation` | 32,036 | 34.6% | 9 |
| `catalogue:query-language-function` | 1,382 | 1.5% | 1 |
...
Read 511 files in 1.5 s — 3.0 ms a file, recorded rather than estimated.

Imports read as this repository's own choice: 81. Set aside as the platform's own vocabulary: 1474. Set aside as this repository's own coordinates: 487. Set aside as the toolchain a source set nothing is published from is checked with: 830. Files the parser refused: 0.