...
The nearest function stands **41.4%** of the maximum divergence away, where a chance partition
of the same statements reaches **38.5%** over 999 draws. This placement **says only that the framework has six functions**.
