...
| **repository** | 354 | 7,685 | 19,436 | 49,768 (71.9%) | 67,654 | **0.978** |

The repository's own words are 69,204 occurrences of 3,460 distinct surfaces, 1,090 of them (31.5%) written exactly once. 254 glued runs no boundary divided were read by the segmenter; 1,550 occurrences across 233 surfaces nothing could be cited for at all.

| Resource | Occurrences it can be cited for | Share | Resting on it alone |
|---|--:|--:|--:|
| `lexicon:word-frequency` | 64,815 | 93.7% | 2,805 |
| `lexicon:wordnet-sense` | 47,435 | 68.5% | 771 |
| `lexicon:wiktionary-topic` | 39,335 | 56.8% | 134 |
| `lexicon:wikidata-initialism` | 31,137 | 45.0% | 81 |
| `lexicon:wordnet-domain` | 29,182 | 42.2% | 75 |
| `lexicon:wikidata-name` | 28,144 | 40.7% | 14 |
| `lexicon:wiktionary-abbreviation` | 25,388 | 36.7% | 2 |
| `catalogue:query-language-function` | 939 | 1.4% | 1 |
...
Read 354 files in 0.2 s — 0.6 ms a file, recorded rather than estimated.
