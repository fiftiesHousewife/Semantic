...
| 9.1% | `publishing` | 0.0108 | 0.0590 | under | `publish`&nbsp;223 `read`&nbsp;137 `write`&nbsp;409 `directory`&nbsp;49 |
| 8.1% | `plants` | 0.0013 | 0.0300 | under | `root`&nbsp;109 `tree`&nbsp;121 `seed`&nbsp;20 `leaf`&nbsp;15 |
| 5.8% | `electronics` | 0.0007 | 0.0205 | under | `tsv`&nbsp;38 `field`&nbsp;159 `default`&nbsp;26 `node`&nbsp;58 |
...
| 2.1% | `lexicography` | 0.0320 | 0.0128 | **over** | `citation`&nbsp;95 `sense`&nbsp;306 `lexicon`&nbsp;160 `gloss`&nbsp;2 |

### `code-semantics-api/src/test/java`

**0.1928 bits** from the repository, against a null median of 0.1378 over 999 resamples of the same size — an excess of +0.0550, and 37 of those draws diverged at least as far. The scope stands outside its own null, so its topics are ranked below.

| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 11.3% | `telecommunication` | 0.0009 | 0.0489 | under | `file`&nbsp;179 `entry`&nbsp;161 `note`&nbsp;9 `record`&nbsp;3 |
| 7.4% | `plants` | 0.0002 | 0.0300 | under | `root`&nbsp;109 `tree`&nbsp;121 `seed`&nbsp;20 `leaf`&nbsp;15 |
| 6.8% | `linguistics` | 0.3994 | 0.2466 | **over** | `word`&nbsp;1,132 `term`&nbsp;307 `name`&nbsp;468 `lexicon`&nbsp;160 |
| 6.0% | `biology` | 0.0343 | 0.0027 | **over** | `morphology`&nbsp;16 `owl`&nbsp;31 `person`&nbsp;20 `glob`&nbsp;5 |
| 5.9% | `literature` | 0.0003 | 0.0244 | under | `header`&nbsp;68 `text`&nbsp;46 `write`&nbsp;409 `title`&nbsp;13 |
| 4.9% | `electronics` | 0.0002 | 0.0205 | under | `tsv`&nbsp;38 `field`&nbsp;159 `default`&nbsp;26 `node`&nbsp;58 |
| 4.7% | `chemistry` | 0.0042 | 0.0330 | under | `extraction`&nbsp;128 `syn`&nbsp;15 `extract`&nbsp;7 `test`&nbsp;177 |
| 4.7% | `publishing` | 0.0168 | 0.0590 | under | `publish`&nbsp;223 `read`&nbsp;137 `write`&nbsp;409 `directory`&nbsp;49 |
...
| 13.8% | `electronics` | 0.0004 | 0.0205 | under | `tsv`&nbsp;38 `field`&nbsp;159 `default`&nbsp;26 `node`&nbsp;58 |
...
| 3.4% | `politics` | 0.0315 | 0.0147 | **over** | `vote`&nbsp;55 `normalisation`&nbsp;13 `reading`&nbsp;497 `name`&nbsp;529 |
...
**0.0677 bits** from the repository, against a null median of 0.0204 over 999 resamples of the same size — an excess of +0.0473, and 0 of those draws diverged at least as far. The scope stands outside its own null, so its topics are ranked below.

| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 18.6% | `chemistry` | 0.0016 | 0.0330 | under | `extraction`&nbsp;128 `syn`&nbsp;15 `extract`&nbsp;7 `test`&nbsp;177 |
| 18.3% | `plants` | 0.0935 | 0.0300 | **over** | `root`&nbsp;109 `tree`&nbsp;121 `seed`&nbsp;20 `leaf`&nbsp;15 |
| 13.9% | `electronics` | 0.0002 | 0.0205 | under | `tsv`&nbsp;38 `field`&nbsp;159 `default`&nbsp;26 `node`&nbsp;58 |
| 2.7% | `publishing` | 0.0859 | 0.0590 | **over** | `publish`&nbsp;223 `read`&nbsp;137 `write`&nbsp;409 `directory`&nbsp;49 |
...
| 7.4% | `linguistics` | 0.1384 | 0.2466 | under | `word`&nbsp;1,132 `term`&nbsp;307 `name`&nbsp;468 `lexicon`&nbsp;160 |
...
| 4.9% | `electronics` | 0.0599 | 0.0205 | **over** | `tsv`&nbsp;38 `field`&nbsp;159 `default`&nbsp;26 `node`&nbsp;58 |
...
| 12.5% | `electronics` | 0.1160 | 0.0205 | **over** | `tsv`&nbsp;38 `field`&nbsp;159 `default`&nbsp;26 `node`&nbsp;58 |
| 4.8% | `grammar` | 0.0056 | 0.0392 | under | `phrase`&nbsp;158 `part_of_speech`&nbsp;42 `verb`&nbsp;66 `occurrence`&nbsp;119 |
| 4.7% | `linguistics` | 0.1435 | 0.2466 | under | `word`&nbsp;1,132 `term`&nbsp;307 `name`&nbsp;468 `lexicon`&nbsp;160 |
...
| 2.9% | `law` | 0.0094 | 0.0364 | under | `file`&nbsp;361 `witness`&nbsp;70 `summary`&nbsp;44 `within`&nbsp;8 |
...
| 6.1% | `publishing` | 0.0165 | 0.0590 | under | `publish`&nbsp;223 `read`&nbsp;137 `write`&nbsp;409 `directory`&nbsp;49 |
...
| 3.6% | `linguistics` | 0.3395 | 0.2466 | **over** | `word`&nbsp;1,132 `term`&nbsp;307 `name`&nbsp;468 `lexicon`&nbsp;160 |
| 3.3% | `law` | 0.0114 | 0.0364 | under | `file`&nbsp;361 `witness`&nbsp;70 `summary`&nbsp;44 `within`&nbsp;8 |

### `lexicon/src/test/java`

**0.1488 bits** from the repository, against a null median of 0.1059 over 999 resamples of the same size — an excess of +0.0430, and 21 of those draws diverged at least as far. The scope stands outside its own null, so its topics are ranked below.

| Share of the divergence | Topic | In scope | In repository | | Carried by |
|--:|---|--:|--:|---|---|
| 17.4% | `linguistics` | 0.4716 | 0.2466 | **over** | `word`&nbsp;1,132 `term`&nbsp;307 `name`&nbsp;468 `lexicon`&nbsp;160 |
| 9.9% | `plants` | 0.0001 | 0.0300 | under | `root`&nbsp;109 `tree`&nbsp;121 `seed`&nbsp;20 `leaf`&nbsp;15 |
| 8.2% | `lexicography` | 0.0605 | 0.0128 | **over** | `citation`&nbsp;95 `sense`&nbsp;306 `lexicon`&nbsp;160 `gloss`&nbsp;2 |
| 6.9% | `electronics` | 0.0000 | 0.0205 | under | `tsv`&nbsp;38 `field`&nbsp;159 `default`&nbsp;26 `node`&nbsp;58 |
| 4.3% | `physics` | 0.0007 | 0.0162 | under | `mass`&nbsp;130 `weight`&nbsp;49 `radius`&nbsp;4 `length`&nbsp;36 |
| 3.0% | `politics` | 0.0016 | 0.0147 | under | `vote`&nbsp;55 `normalisation`&nbsp;13 `reading`&nbsp;497 `name`&nbsp;529 |
...
**0.2729 bits** from the repository, against a null median of 0.3190 over 999 resamples of the same size — an excess of -0.0461, and 797 of those draws diverged at least as far. **The scope does not stand outside its own null**, so it has no topical content beyond its size and nothing is ranked.
