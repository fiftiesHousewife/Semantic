...
| Evidence resolving to no subject | 67.2% |
...
|---|---|--:|--:|---|
| Archive | **Computer Science** | 37.2% | 42.5% | apart from chance |
| Category | **Computation and Language** | 39.2% | 43.1% | apart from chance |
...
|---|--:|---|
| `tika-translate/src/test/java` | 41.5% | `linguistics` |
| `tika-langdetect/tika-langdetect-charsoup-core/src/main/java` | 33.9% | `linguistics` |
| `documentation` | 31.8% | `linguistics` |
