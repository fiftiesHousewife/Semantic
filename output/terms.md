...
**OLiA** publishes **1,311 concepts** in a hierarchy nine levels deep. This repository writes **65 of them, 1,237 times**, across 306 of 408 files — reaching **12 of the taxonomy's 70 root branches**.
...
|---|--:|--:|--:|---|
| `LinguisticConcept` | 15 | 136 | 520 | `Source`&nbsp;180 `Set`&nbsp;91 `Citation`&nbsp;46 `Evidence`&nbsp;32 `Means`&nbsp;31 `Document`&nbsp;26 `Given`&nbsp;24 `PartOf`&nbsp;21 |
| `MorphosyntacticCategory` | 13 | 288 | 156 | `Noun`&nbsp;34 `Verb`&nbsp;34 `Abbreviation`&nbsp;23 `Symbol`&nbsp;16 `Foreign`&nbsp;12 `Initialism`&nbsp;11 `Residual`&nbsp;11 `Adjective`&nbsp;6 |
| `OrthographicEntity` | 4 | 37 | 138 | `Token`&nbsp;87 `Text`&nbsp;33 `Script`&nbsp;16 `String`&nbsp;2 |
| `MorphologicalCategory` | 5 | 16 | 135 | `Root`&nbsp;102 `Prefix`&nbsp;15 `Suffix`&nbsp;12 `Stem`&nbsp;5 `Affix`&nbsp;1 |
| `Constituent` | 4 | 37 | 85 | `Phrase`&nbsp;67 `Fragment`&nbsp;9 `Clause`&nbsp;7 `Chunk`&nbsp;2 |
| `PersonFeature` | 3 | 10 | 85 | `First`&nbsp;59 `Second`&nbsp;25 `Third`&nbsp;1 |
| `SemanticFeature` | 5 | 125 | 59 | `Function`&nbsp;36 `Time`&nbsp;8 `Amount`&nbsp;7 `Object`&nbsp;4 `Plan`&nbsp;4 |
...
| `DegreeFeature` | 3 | 5 | 4 | `Positive`&nbsp;2 `Comparative`&nbsp;1 `Superlative`&nbsp;1 |
...
|---|--:|--:|--:|
| the words themselves | 928 | 57 | 97.5% |
| the dictionary form of each word | 186 | 33 | 99.5% |
| the sense the dictionary carries each word in | 123 | 21 | 99.2% |
...
|---|--:|--:|--:|--:|---|
| every match | 1,948 | 166 | 98.7% | 22 of 70 | `topic`&nbsp;186 |
| only where the branch holds more than this one concept | 1,237 | 111 | 98.0% | 12 of 70 | `source`&nbsp;145 |

### What the branch refused

**55 terms**, most-written first, each of them the one concept this repository writes in the region of the field its publisher placed it in.

| Term | Times | Stood alone under |
|---|--:|---|
| `topic` | 186 | `PragmaticUnit` |
...
|---|--:|--:|--:|--:|
| what the branch admitted | 65 | 1,237 | 2.17 | 2.17 |
| what the branch refused | 34 | 721 | 3.06 | 2.45 |
...
The shallowest: `Verb`&nbsp;1&nbsp;rung,&nbsp;34 `Trial`&nbsp;1&nbsp;rung,&nbsp;1 `Token`&nbsp;1&nbsp;rung,&nbsp;87 `Third`&nbsp;1&nbsp;rung,&nbsp;1 `Text`&nbsp;1&nbsp;rung,&nbsp;33 `Superlative`&nbsp;1&nbsp;rung,&nbsp;1 `String`&nbsp;1&nbsp;rung,&nbsp;2 `Singular`&nbsp;1&nbsp;rung,&nbsp;2.
