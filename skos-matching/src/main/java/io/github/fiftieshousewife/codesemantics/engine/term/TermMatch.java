 ...
 *
 * <p>The normalisation is carried per match rather than per reading, so nothing can sum a figure across normalisations
 * by accident: a term found in the words the repository wrote and a term found in what the dictionary says those words
 * mean are different strengths of evidence.
 *
 ...
 * @param normalisation        what the two sides were compared at
 ...
 */
public record TermMatch(String vocabulary, String term, int wordsInTerm, MatchNormalisation normalisation,
                        double specificity, int occurrences, TermOutcome outcome, List<String> concepts,
                        List<String> sites) {
